...
def evaluate_two_step_model(dataset, output_filename):
    ...
    for j in range(K):
        ...
        model_binary = SVC(C=SELECTED_C_BINARY, class_weight='balanced')
        ...
        base_model_nfr = SVC(C=SELECTED_C_NFR, class_weight='balanced')
...
bow = evaluate_two_step_model('bow-12', 'two-step-bow-svm')
tfidf = evaluate_two_step_model('tfidf-12', 'two-step-tfidf-svm')
print('{}\n\n{}'.format(bow, tfidf))