...
def evaluate_multiclass_model(dataset, output_filename):
    ...
    for j in range(K):
        ...
        model = LogisticRegression(C=SELECTED_C, class_weight='balanced', multi_class='multinomial')
...
bow = evaluate_multiclass_model('bow-12', '12-bow-lr')
tfidf = evaluate_multiclass_model('tfidf-12', '12-tfidf-lr')
print('{}\n\n{}'.format(bow, tfidf))