...
def evaluate_two_step_model(dataset, output_filename):
    ...
    for j in range(K):
        ...
        model_binary = LogisticRegression(C=SELECTED_C_BINARY, class_weight='balanced')
        ...
        model_nfr = LogisticRegression(C=SELECTED_C_NFR, class_weight='balanced', multi_class='multinomial')
...
bow = evaluate_two_step_model('bow-12', 'two-step-bow-lr')
tfidf = evaluate_two_step_model('tfidf-12', 'two-step-tfidf-lr')
print('{}\n\n{}'.format(bow, tfidf))