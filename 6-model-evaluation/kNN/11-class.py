...
def evaluate_multiclass_model(dataset, output_filename, selected_k):
    ...
    for j in range(K):
        ...
        model = KNeighborsClassifier(n_neighbors=selected_k, weights='distance')
...
bow = evaluate_multiclass_model('bow-11', '11-bow-knn', 1)
tfidf = evaluate_multiclass_model('tfidf-11', '11-tfidf-knn', 1)
print('{}\n\n{}'.format(bow, tfidf))