...
def evaluate_binary_model(dataset, output_filename, selected_k):
...
bow = evaluate_binary_model('bow-2', '2-bow-knn', 11)
tfidf = evaluate_binary_model('tfidf-2', '2-tfidf-knn', 11)
print('{}\n\n{}'.format(bow, tfidf))