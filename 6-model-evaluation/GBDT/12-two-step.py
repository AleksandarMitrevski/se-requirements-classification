...
SELECTED_ESTIMATORS_BINARY = 200
SELECTED_LEARNING_RATE_BINARY = 0.05
SELECTED_ESTIMATORS_NFR = 200
SELECTED_LEARNING_RATE_NFR = 0.05

def evaluate_two_step_model(dataset, output_filename):
    ...
    for j in range(K):
        ...
        model_binary = GradientBoostingClassifier(n_estimators=SELECTED_ESTIMATORS_BINARY, learning_rate=SELECTED_LEARNING_RATE_BINARY, max_features='sqrt')
        ...
        model_nfr = GradientBoostingClassifier(n_estimators=SELECTED_ESTIMATORS_NFR, learning_rate=SELECTED_LEARNING_RATE_NFR, max_features='sqrt')
...
bow = evaluate_two_step_model('bow-12', 'two-step-bow-gbdt')
tfidf = evaluate_two_step_model('tfidf-12', 'two-step-tfidf-gbdt')
print('{}\n\n{}'.format(bow, tfidf))