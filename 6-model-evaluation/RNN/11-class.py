...
def evaluate_multiclass_model(output_filename_base, mode, param_epochs, param_dropout, param_dense_dropout, param_dense_nodes, param_leaky_relu_alpha):
    ...
    embeddings_matrix, max_sequence_length, dataset = utils.load_dataset_word2vec('./GoogleNews-vectors-negative300.bin', '../../2-preprocessing/output', '11-class')
...
lstm = evaluate_multiclass_model('11-w2v', 'lstm', 80, 0.7, 0.7, 20, 0.3)
gru = evaluate_multiclass_model('11-w2v', 'gru', 80, 0.7, 0.7, 20, 0.3)
print('{}\n\n{}'.format(lstm, gru))